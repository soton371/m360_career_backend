...
Future<bool> sendOTPSMTP(String recipientEmail, String otp) async {
  ...
  final message = Message()
    ..from = Address(senderEmail, 'M360 Career')
                ...
                <td style="padding: 40px 0px 0px;">
                  ...
                  <div style="padding: 30px; background-color: rgb(255, 255, 255);">
                    <div style="color: rgb(0, 0, 0); text-align: left;">
                      <h2 style="margin: 1rem 0">Verify Your M360 Career Account</h2>
                     <p>Hi,</p> 
                      <p style="padding-bottom: 16px">Thanks for joining M360 Career! To verify your account, please enter the following 4-digit OTP code:</p>
